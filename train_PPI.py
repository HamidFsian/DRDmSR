...
parser.add_argument("--pretrained", default="checkpoint/pre-training/PPI_model_epoch_2000.pth", type=str, help="path to pretrained model (default: none)")
parser.add_argument('--msfa_size', '-uf',  type=int, default=4, help="the size of square msfa")
parser.add_argument("--train_dir", default="C:/Users/hamid/Desktop/python_projects/My_joint_DMSR/train_data/Train_spectral_16", type=str, help="path to train dataset")
parser.add_argument("--val_dir", default="C:/Users/hamid/Desktop/python_projects/My_joint_DMSR/train_data/validation_spectrao_16", type=str, help="path to validation dataset")
